...
-- Module  Version: 7.5
--C:\lscc\diamond\3.9_x64\ispfpga\bin\nt64\scuba.exe -w -n dma_mem -lang vhdl -synth lse -bus_exp 7 -bb -arch xo2c00 -type bram -wp 11 -rp 1010 -data_width 8 -rdata_width 8 -num_rows 1024 -cascade -1 -mem_init0 -writemodeA NORMAL -writemodeB NORMAL 

-- Fri Jun 30 16:39:30 2017
...
architecture Structure of dma_mem is
    ...
    attribute MEM_LPC_FILE of dma_mem_0_0_0 : label is "dma_mem.lpc";
    attribute MEM_INIT_FILE of dma_mem_0_0_0 : label is "INIT_ALL_0s";
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of dma_mem is
    for Structure
