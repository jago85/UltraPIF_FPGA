...
-- Module  Version: 1.2
--C:\lscc\diamond\3.9_x64\ispfpga\bin\nt64\scuba.exe -w -n efb_core -lang vhdl -synth lse -bus_exp 7 -bb -type efb -arch xo2c00 -freq 66.5 -i2c2 -i2c2_freq 100 -i2c2_sa 1000010 -i2c2_addr 7 -spi -spi_mode Slave -wb -dev 2000 
...
architecture Structure of efb_core is
    ...
    signal i2c2_scloen: std_logic;
    signal i2c2_sclo: std_logic;
    signal i2c2_sdai: std_logic;
    signal i2c2_scli: std_logic;
...
begin
    ...
    BB2_sda: BB
        port map (I=>i2c2_sdao, T=>i2c2_sdaoen, O=>i2c2_sdai, 
            B=>i2c2_sda);

    BB2_scl: BB
        port map (I=>i2c2_sclo, T=>i2c2_scloen, O=>i2c2_scli, 
            B=>i2c2_scl);
    ...
    EFBInst_0: EFB
        ...
        UFM_INIT_PAGES=>  0, DEV_DENSITY=> "2000L", EFB_UFM=> "DISABLED", 
        ...
        I2C2_CLK_DIVIDER=>  167, I2C2_BUS_PERF=> "100kHz", 
        I2C2_SLAVE_ADDR=> "0b1000010", I2C2_ADDRESSING=> "7BIT", 
        EFB_I2C2=> "ENABLED", I2C1_WAKEUP=> "DISABLED", I2C1_GEN_CALL=> "DISABLED", 
        I2C1_CLK_DIVIDER=>  1, I2C1_BUS_PERF=> "100kHz", I2C1_SLAVE_ADDR=> "0b1000010", 
        I2C1_ADDRESSING=> "7BIT", EFB_I2C1=> "DISABLED", EFB_WB_CLK_FREQ=> "66.5")
        port map (WBCLKI=>wb_clk_i, WBRSTI=>wb_rst_i, WBCYCI=>wb_cyc_i, 
            ...
            I2C1SDAI=>scuba_vlo, I2C2SCLI=>i2c2_scli, 
            I2C2SDAI=>i2c2_sdai, SPISCKI=>spi_clk_i, 
            ...
            I2C1SDAO=>open, I2C1SDAOEN=>open, I2C2SCLO=>i2c2_sclo, 
            I2C2SCLOEN=>i2c2_scloen, I2C2SDAO=>i2c2_sdao, 
            I2C2SDAOEN=>i2c2_sdaoen, I2C1IRQO=>open, I2C2IRQO=>i2c2_irqo, 
            SPISCKO=>spi_clk_o, SPISCKEN=>spi_clk_oe, 
